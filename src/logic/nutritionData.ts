...
export const NUTRITION_DATA: NutritionData = {
  ...
  "foods": [
    ...
    },
    {
      ...
      "note": "八訂にパプリカ(野菜)専用の項目が無いため、最も近い赤ピーマンの値で代表(赤・黄・オレンジパプリカを一括りにした一般名としての「パプリカ」もここに寄せる)。1個=150gは一般的な調理の目安量(MEXTの値ではない概算)。スパイスの「パプリカ(粉/パウダー)」とは全く別の食品なので混同しないこと(下記17079参照。「パプリカパウダー」「パプリカ粉」等パウダーと明記された表記のみそちらに寄せ、無印の「パプリカ」は野菜側を優先=一般的な使用頻度の高さを優先した判断)"
    },
    {
      "id": "17079",
      "label": "パプリカ(粉)",
